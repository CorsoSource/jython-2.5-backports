...
def test_undirected_aux_graph():
    ...
    target_1 = fset([set([a, b, c, d, e, f, g]), set([h, i])])
    ...
    target_2 = fset([set([a, b, c, d, e, f, g]), set([h]), set([i])])
    ...
    target_3 = fset([set([a]), set([b, c, f, g]), set([d]), set([e]), set([h]), set([i])])
    assert_equal(target_3, components_3)

    components_4 = fset(aux_graph.k_edge_subgraphs(k=4))
    target_4 = fset([set([a]), set([b]), set([c]), set([d]), set([e]), set([f]), set([g]), set([h]), set([i])])
...
def test_local_subgraph_difference():
    ...
    subgraph_target = fset([set([101]), set([102]), set([103]), set([104]),
                            set([21, 22, 23, 24]), set([11, 12, 13, 14])])
    ...
    local_target = fset([set([101]), set([102]), set([103]), set([104]),
                         set([11, 12, 13, 14, 21, 22, 23, 24])])
...
def test_four_clique():
    ...
    assert_in(clique1.union(clique2).union(set([100])), local_ccs)
