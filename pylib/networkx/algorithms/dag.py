...
from networkx.compat import product, chain
...
def gcd(a, b):
    ...
    See https://stackoverflow.com/a/11175154
    """
    while b:
        a, b = b, a%b
    return a
...
def topological_sort(G):
    ...
    indegree_map = dict((v, d) for v, d in G.in_degree() if d > 0)
        ...
        for v in G[u]:
            if v in u_nbrs:
                if v not in descendants:
                    descendants[v] = set([y for x, y in nx.dfs_edges(G, v)])
