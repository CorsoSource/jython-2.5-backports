...
def validate_flows(G, s, t, soln_value, R, flow_func):
    ...
    assert_equal(soln_value, flow_value, msg=msg % (flow_func.__name__,))
    assert_equal(set(G), set(flow_dict), msg=msg % (flow_func.__name__,))
    for u in G:
    ...
    for u, exc in excess.items():
        if u == s:
            assert_equal(exc, -soln_value, msg=msg % (flow_func.__name__,))
        elif u == t:
            assert_equal(exc, soln_value, msg=msg % (flow_func.__name__,))
        else:
