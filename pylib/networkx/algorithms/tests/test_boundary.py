...
from networkx.compat import combinations
...
class TestNodeBoundary(object):
    ...
    def test_path_graph(self):
        ...
        assert_equal(nx.node_boundary(P10, [], []), set())
        assert_equal(nx.node_boundary(P10, [1, 2, 3]), set([4]))
        assert_equal(nx.node_boundary(P10, [4, 5, 6]), set([3, 7]))
        assert_equal(nx.node_boundary(P10, [3, 4, 5, 6, 7]), set([2, 8]))
        assert_equal(nx.node_boundary(P10, [8, 9, 10]), set([7]))
    ...
    def test_complete_graph(self):
        ...
        assert_equal(nx.node_boundary(K10, [], []), set())
        assert_equal(nx.node_boundary(K10, [1, 2, 3]), set([4, 5, 6, 7, 8, 9, 10]))
        assert_equal(nx.node_boundary(K10, [4, 5, 6]), set([1, 2, 3, 7, 8, 9, 10]))
        assert_equal(nx.node_boundary(K10, [3, 4, 5, 6, 7]), set([1, 2, 8, 9, 10]))
        assert_equal(nx.node_boundary(K10, [4, 5, 6], []), set())
        assert_equal(nx.node_boundary(K10, K10), set())
        assert_equal(nx.node_boundary(K10, [1, 2, 3], [3, 4, 5]), set([4, 5]))
