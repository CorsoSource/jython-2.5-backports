...
from networkx.compat import permutations
...
class TestIsMatching(object):
    ...
    def test_single_edge(self):
        G = nx.path_graph(4)
        assert_true(nx.is_matching(G, set([(1, 2)])))

    def test_edge_order(self):
        G = nx.path_graph(4)
        assert_true(nx.is_matching(G, set([(0, 1), (2, 3)])))
        assert_true(nx.is_matching(G, set([(1, 0), (2, 3)])))
        assert_true(nx.is_matching(G, set([(0, 1), (3, 2)])))
        assert_true(nx.is_matching(G, set([(1, 0), (3, 2)])))
    ...
    def test_invalid(self):
        G = nx.path_graph(4)
        assert_false(nx.is_matching(G, set([(0, 1), (1, 2), (2, 3)])))
...
class TestIsMaximalMatching(object):
    ...
    def test_valid(self):
        G = nx.path_graph(4)
        assert_true(nx.is_maximal_matching(G, set([(0, 1), (2, 3)])))
    ...
    def test_not_maximal(self):
        G = nx.path_graph(4)
        assert_false(nx.is_maximal_matching(G, set([(0, 1)])))
...
class TestIsPerfectMatching(object):
    ...
    def test_valid(self):
        G = nx.path_graph(4)
        assert_true(nx.is_perfect_matching(G, set([(0, 1), (2, 3)])))
    ...
    def test_valid_not_path(self):
        ...
        assert_true(nx.is_perfect_matching(G, set([(1, 4), (0, 3), (5, 2)])))

    def test_not_matching(self):
        G = nx.path_graph(4)
        assert_false(nx.is_perfect_matching(G, set([(0, 1), (1, 2), (2, 3)])))
    ...
    def test_maximal_but_not_perfect(self):
        ...
        assert_false(nx.is_perfect_matching(G, set([(1, 4), (0, 3)])))
