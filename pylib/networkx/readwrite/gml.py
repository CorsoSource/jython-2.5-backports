...
def parse_gml_lines(lines, label, destringizer):
    ...
    def parse_kv(curr_token):
        ...
        dct = dict((key, (value if not isinstance(value, list) or len(value) != 1
...
def generate_gml(G, stringizer=None):
    ...
    if multigraph:
        yield '  multigraph 1'
    ignored_keys = set(['directed', 'multigraph', 'node', 'edge'])
    ...
    # Output edge data
    ignored_keys = set(['source', 'target'])
    kwargs = {'data': True}
    if multigraph:
