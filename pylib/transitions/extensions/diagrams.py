        ...
        if use_pygraphviz:
            try:
                ...
                if hasattr(self.state_cls, 'separator') and hasattr(self, '__enter__'):
                    from transitions.extensions.diagrams_pygraphviz import NestedGraph as Graph
                    self.machine_attributes.update(self.hierarchical_machine_attributes)
                else:
                    from transitions.extensions.diagrams_pygraphviz import Graph
                return Graph
            except ImportError:
                pass
        if hasattr(self.state_cls, 'separator') and hasattr(self, '__enter__'):
            from transitions.extensions.diagrams_graphviz import NestedGraph as Graph
            self.machine_attributes.update(self.hierarchical_machine_attributes)
        else:
