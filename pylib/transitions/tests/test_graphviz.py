...
from transitions.tests.test_core import TestTransitions
    ...
    def test_nested_notebook(self):
        ...
        transitions = [
            ...
            {'trigger': 'drink', 'source': '*',
             'dest': 'caffeinated%sdithering' % (self.machine_cls.state_cls.separator,),
        ...
        if self.use_pygraphviz:
            ...
            dot_string = g1.source
        count = re.findall('-> "?caffeinated%sdithering"?' % (machine.state_cls.separator,), dot_string)
