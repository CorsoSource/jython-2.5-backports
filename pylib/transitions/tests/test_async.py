...
from transitions.tests.test_core import TestTransitions, MachineError
from transitions.tests.utils import DummyModel
...
class TestHierarchicalAsync(TestAsync):
    ...
    def test_nested_async(self):
        ...
        self.assertEqual('C%s2%sa' % (machine.state_cls.separator,machine.state_cls.separator), machine.state)
    ...
    def test_parallel_async(self):
        ...
        self.assertEqual(['P%s1%sa' % (machine.state_cls.separator,machine.state_cls.separator),
                          'P%s2%sb' % (machine.state_cls.separator,machine.state_cls.separator),
                          'P%s3%sy' % (machine.state_cls.separator,machine.state_cls.separator)], machine.state)
