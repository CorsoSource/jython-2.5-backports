...
class WorkSheetParser(object):
            ...
            if data_type == 'n':
                ...
                if style_id in self.date_formats:
                    ...
                    try:
                        ...
                        msg = """Cell %s is marked as a date but the serial value %s is outside the limits for dates. The cell will be treated as an error.""" % (coordinate, value)
                        warn(msg)
                        data_type = "e"
                        value = "#VALUE!"
            elif data_type == 's':
    ...
    def parse_extensions(self, element):
        ...
        for e in extLst.ext:
            ...
            msg = "%s extension is not supported and will be removed" % ext_type
            warn(msg)
