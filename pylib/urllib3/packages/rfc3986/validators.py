...
class Validator(object):
    ...
    def check_validity_of(self, *components):
        ...
        self.validated_components.update(dict( (component, True) for component in components))
        return self
    ...
    def require_presence_of(self, *components):
        ...
        self.required_components.update(dict( (component, True) for component in components))
        return self
